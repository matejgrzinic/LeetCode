...
func Test(fn testFunc) {
	...
	equals(LinkedList([]int{1, 2, 3, 3, 4, 4, 5}), LinkedList([]int{1, 2, 5}))
	equals(LinkedList([]int{}), LinkedList([]int{}))
	equals(LinkedList([]int{1, 1}), LinkedList([]int{}))
	equals(LinkedList([]int{1, 1, 1, 2, 3, 3}), LinkedList([]int{2}))
	equals(LinkedList([]int{1, 1, 1, 2, 3}), LinkedList([]int{2, 3}))
