...
func Test(fn testFunc) {
	...
	equals(BinaryTree([]string{"5", "4", "8", "11", "nil", "13", "4", "7", "2", "nil", "nil", "nil", "nil", "5", "1"}), 22, [][]int{{5, 4, 11, 2}, {5, 8, 4, 5}})
	equals(BinaryTree([]string{"2"}), 22, [][]int{})
...
func equals(p *TreeNode, sum int, expected [][]int) {
	numTests++
