...
type testFunc func(*TreeNode) bool
...
func Test(fn testFunc) {
	...
	equals(BinaryTree([]string{"1", "2", "2", "3", "4", "4", "3"}), true)
	equals(BinaryTree([]string{"1", "2", "2", "nil", "3", "nil", "3"}), false)
	equals(BinaryTree([]string{"1", "2", "2", "2", "null", "2"}), false)
...
func equals(p *TreeNode, expected bool) {
	numTests++
	got := testFunction(p)
	if got != expected {
